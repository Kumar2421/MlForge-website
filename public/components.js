  ...
  <div class="max-w-[1200px] mx-auto px-6 h-16 flex items-center justify-between">
    <div class="flex items-center gap-12">
      <a href="landing_page.html" class="flex items-center gap-3 group">
        <img src="logo.jpeg" alt="ML Forge" class="w-8 h-8 rounded shadow-[0_0_15px_rgba(102,255,153,0.3)] transition-all duration-300 group-hover:scale-110 group-hover:rotate-6" />
      ...
      <div class="hidden lg:flex items-center gap-8 text-[13px] font-medium text-gray-400">
        <div class="relative group">
          <button class="flex items-center gap-1 hover:text-white transition-colors py-5 text-glow-hover">Product <span class="material-icons-outlined text-[14px]">expand_more</span></button>
        ...
        <div class="relative group">
          <button class="flex items-center gap-1 hover:text-white transition-colors py-5 text-glow-hover">Solutions <span class="material-icons-outlined text-[14px]">expand_more</span></button>
          <div class="absolute top-full left-0 w-64 pt-2 opacity-0 pointer-events-none group-hover:opacity-100 group-hover:pointer-events-auto transition-all transform translate-y-1 group-hover:translate-y-0">
        ...
        <div class="relative group">
          <button class="flex items-center gap-1 hover:text-white transition-colors py-5 text-glow-hover">Developers <span class="material-icons-outlined text-[14px]">expand_more</span></button>
          <div class="absolute top-full left-0 w-64 pt-2 opacity-0 pointer-events-none group-hover:opacity-100 group-hover:pointer-events-auto transition-all transform translate-y-1 group-hover:translate-y-0">
             <div class="bg-[#111] border border-[#ffffff08] rounded-xl p-3 shadow-2xl">
      ...
      <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-12 mb-24">
        <div class="col-span-2">
          <a href="landing_page.html" class="flex items-center gap-3 mb-8 group">
            <img src="logo.jpeg" alt="ML Forge" class="w-10 h-10 rounded shadow-[0_0_15px_rgba(102,255,153,0.2)] transition-transform group-hover:scale-110" />
